...
public class Client {
	 ...
	 * @return 连接
	 */
	public static Connection connect(String ip, String usr, String psword){
	...
	/**
	  ...
	  */
	public static void upload(Connection conn, String fileName, String remotePath){
	 ...
	 * @throws Exception 
	 */
	public static String exec(Connection conn, String cmds, int timeout) throws Exception{
