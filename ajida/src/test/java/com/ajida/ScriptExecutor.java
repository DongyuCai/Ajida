...
//			xjp_45();
	...
	public static void mvnPackageWarApplication(String projectDir,String configDir) throws Exception{
		try {
			...
			ZipUtil.zip(new File(projectDir+"\\target\\"+projectName), projectDir+"\\target\\"+projectName+".war",null,null);
	...
	public static void htmlPackageZip(String projectDir,String configDir) throws Exception{
		try {
			...
			ZipUtil.zip(new File(projectDir+"\\"+projectName), projectDir+"\\"+projectName+".zip",null, null);
